...
<img src="{{ site.url }}/img/zojregister.jpg" width="680" alt="">
##登陆
在首页中点击[Login](http://acm.zju.edu.cn/onlinejudge/login.do/)即可打开登陆界面，如图所示
<img src="{{ site.url }}/img/zojlogin.jpg" width="680" alt="">
<div class="note info">
  <p>
